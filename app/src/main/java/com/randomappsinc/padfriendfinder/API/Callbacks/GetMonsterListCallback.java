 ...
 */
public class GetMonsterListCallback extends StandardCallback<List<MonsterAttributes>> {
    public GetMonsterListCallback() {
        super(MainActivity.LOG_TAG, MyApplication.getAppContext().getString(R.string.monster_list_fail));
    }
